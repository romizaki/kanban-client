      ...
      <div>
        <form @submit.prevent="editTask">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="titleTaskEdit" v-model="title" placeholder="Enter Your Task" rows="3"></textarea>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Your Category Task</label>
            <select class="form-control form-control-sm" v-model="category" id="categoryTaskEdit">
